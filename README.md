...
- better interface [########=] 96% done
- more wallpapers [#######===] 70% done
- wallpaper image previews [##########] completed in beta 1.1-b
- fix bitrate issues i've been having on some devices
- interactive wallpapers [#####=====] 50% done, coming soon to preview branch.
